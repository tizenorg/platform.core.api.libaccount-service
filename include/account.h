 ...
 * @privilege     %http://tizen.org/privilege/account.read
 * @param[in]     app_id        The application ID to search
 * @param[in/out] account_type  The account handle which has to created by account_type_create() before calling this function and released by account_type_destroy() after calling this function.
 *
 * @return  @c 0 on success,
 *          otherwise a negative error value
 * @retval  #ACCOUNT_ERROR_NONE               Successful
